...
{
    public class CInfoEnemy : CInfoGameObjectAl
    {
        ...
        public CInfoEnemy(Game1 game, string skinName, Vector2 position, int speed, int damage)
        ...
        public CInfoEnemy(Game1 game, string skinName, Vector2 position, int speed, int damage, int hp)
            : base(game, skinName, position, speed, damage)
        {
            this.hp = hp;
            FolderSkin = "Images/Enemy/";
